(() => {
  ...
  function renderShell() {
    root.innerHTML = `
      <section class="users-surface prospects-surface">
        <div class="surface-toolbar prospects-toolbar">
          <div>
            <h2>Prospectos y correos</h2>
            <p class="muted-text" data-prospects-message>Cargando CRM...</p>
          </div>
          <div class="prospects-toolbar-actions">
            <label class="surface-mobile-search prospects-search">
              <i data-lucide="search"></i>
              <input type="search" data-prospect-search placeholder="Buscar prospectos..." autocomplete="off" />
            </label>
        ...
        <section class="prospects-insights">
          <article class="activity-surface prospects-panel">
          ...
          <article class="activity-surface prospects-panel">
            <div class="activity-head">
              <h3>Correos enviados por fase</h3>
        ...
        <section class="prospects-board" data-prospects-board></section>
        <section class="prospects-grid">
          <article class="activity-surface prospects-panel">
            <div class="activity-head">
        ...
        <section class="prospects-grid prospects-grid-bottom prospects-grid-bottom-split">
          <article class="activity-surface prospects-panel">
            <div class="activity-head">
              <h3>Plantillas</h3>
  ...
  function setMessage(text, tone = "neutral") {
    ...
    if (!message) return;
    message.textContent = text || "Gestiona prospectos, seguimiento y plantillas.";
