-- Run after SUPABASE_AUTH_SETUP.sql and SUPABASE_CUSTOM_ROLES.sql.
-- Enables the two built-in MAPs staff roles in the existing access-assignment RPC.
...
begin
  ...
  if not clean_staff_roles <@ array[
    ...
    'maps_license_manager', 'maps_product_analyst'
  ]::text[] then
