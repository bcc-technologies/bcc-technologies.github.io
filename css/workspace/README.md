...
- `workspace-core.css`: shared layout primitives, filters, tables, metrics and activity feeds.
- `workspace-shell.css`: refined dashboard shell layout, sidebar chrome and collapsed state.
...
- `workspace-customer.css`: customer dashboard skin and layout refinements.
- `workspace-internal.css`: staff/admin dashboard skin and layout refinements.
